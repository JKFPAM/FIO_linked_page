...
// videoOverlay.src = 'Denk_Interactive_Animation .mp4';  // Ensure correct video path
...
videoOverlay.addEventListener('ended', function() {
    ...
    // Redirect to the specified URL after the video ends
    window.location.href = "https://fiosystem.netlify.app/";
});
